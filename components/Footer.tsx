      ...
      <div className="container-custom py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#problem" className="text-gray-300 hover:text-white transition-colors">Problem</Link></li>
              <li><Link href="#solution" className="text-gray-300 hover:text-white transition-colors">Solution</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <a href="https://www.instagram.com/solivradiy/" className="text-gray-400 hover:text-white transition-colors">
